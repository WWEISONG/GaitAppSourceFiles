...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    // up down
    // 0-p4 1-p5
    private String pre = "old_tap_3_0_down_";

    public EditText ph_input;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ph_input = findViewById(R.id.ph_input);
    ...
    public void startRandomVibration() {
        // 250ms, 50ms, 100ms,
//        long[] VIBRATE_PATTERN = new long[]{0, 150, 50, 150, 50, 150, 50, 150, 50, 150, 50};
//        int[] VIBRATE_AMP = new int[]{0, 200, 0, 255, 0, 100, 0, 150, 0, 50, 0};
...
//            lowPassFilter();
    ...
    public void start_cp() {
        ...
        Date date = new Date();
        String ph_input_str = ph_input.getText().toString();
        this.accOutputFileName = pre + times + "_" + ph_input_str + "_acc.csv";
        this.gyroOutputFileName = pre + times + "_" + ph_input_str + "_gyro.csv";
        this.heartOutputFileName = pre + times + "_" + ph_input_str + "_heart_rate.csv";
        count = 0;
